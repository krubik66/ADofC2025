...
public class MathIsEasy {
    private long sumOfFresh;
    private final boolean isItFirst;
    private boolean isItFinished = false;
    private final ArrayList<ArrayList<String>> problems = new ArrayList<>();

    public MathIsEasy(boolean first) {
        this.sumOfFresh = 0;
    ...
    private long getAllRanges() {
        ...
        problems.sort(Comparator.comparingLong(
